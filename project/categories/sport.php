	...
	<section class="header">
		<div class="container">
			<ul class="subheader">
				...
				<a href="http://localhost/project/searchLayOut.php" style="color:orange">СПОРТ И ФИТНЕС</a>
...
<section class="body">
		<div class="container">
			...
			<h3 style="margin: 37px">Спорт и Фитнес</h3>

				<div class="rows">
				<?php $i = 0; ?>
				<?php while($i++ != 10) {   
					$row = $result->fetch_assoc();
					if($row['tag'] == 'спорт и фитнес'){ ?>
