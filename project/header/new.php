...
// $lastIndex = 'SELECT MAX(id) FROM news';

$result = $conn->query($sql);

// $get=mysql_query( "SELECT * FROM news
...
<body>
		    ...
		    <div class="container">
		      ...
		      <nav>
		        <ul>
		          ...
		          <li class="new"><a href="#" style="color:white">СВЕЖЕЕ</a></li>
	...
	<section class="body">
		<div class="container">
			...
			<h3 style="margin: 37px">Все статьи</h3>

			<div class="rows">		
				<?php $lastIndex = 0?>
				<?php while($lastIndex++ != mysqli_num_rows($result)) {   
